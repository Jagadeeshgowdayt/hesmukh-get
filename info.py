...
API_HASH = environ.get('API_HASH', 'f0184f4c1bad2efdc2f59839')  # API Hash from my.telegram.org
BOT_TOKEN = environ.get('BOT_TOKEN', "8251ydkIE_PUc")    # Bot token from @BotFather

# Second Bot Configuration
SESSION2 = environ.get('SESSION2', 'X_ploreFlix_1080_search_2')   # Session name for the second bot
BOT_TOKEN2 = environ.get('BOT_TOKEN2', "83200IZ6O6Xwrrds-qQU2jdjl8")    # Second bot token from @BotFather

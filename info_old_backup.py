...
BOT_TOKEN = environ.get('BOT_TOKEN', "8251332933:AAHgs4HW_ZGdydkIE_PUc")    # Bot token from @BotFather
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/XploreFlix_1080')  # Support group link (make sure bot is admin)
...
reqst_channel = environ.get('REQST_CHANNEL', '-1002723371583')
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002723371583')
...
DATABASE_URI2 = environ.get('DATABASE_URI2', DATABASE_URI)  # Second database URI for compatibility
...
PAYMENT_QR = environ.get('PAYMENT_QR', 'https://envs.sh/dcx.png') # payment code picture url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/XploreFlix_1080')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/XploreFlix_1080')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'XploreFlix_1080') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/XploreFlix_1080')
